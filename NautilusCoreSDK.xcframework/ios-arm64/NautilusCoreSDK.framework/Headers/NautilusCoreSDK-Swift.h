...
/// タスクのキャンセル（旧サービスクラス用）
/// note:
/// NautilusSerialServiceActor / NautilusConcurrentServiceActor クラスがサービスクラスの場合は何もしません
- (void)cancel;
@end
...
SWIFT_ENUM_FWD_DECL(NSInteger, NautilusDeploymentEnvironment)
...
SWIFT_ENUM_FWD_DECL(NSInteger, NautilusAppInitializationError)
