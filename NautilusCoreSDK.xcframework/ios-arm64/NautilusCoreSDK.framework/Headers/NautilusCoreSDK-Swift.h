...
SWIFT_CLASS("_TtC15NautilusCoreSDK18NautilusCodeReader")
...
static NSString * _Nonnull const NautilusCodeReaderErrorDomain = @"NautilusCoreSDK.NautilusCodeReaderError";


/// コード読み込み結果を受け取るプロトコル
SWIFT_PROTOCOL("_TtP15NautilusCoreSDK25NautilusCodeReaderHandler_")
@protocol NautilusCodeReaderHandler
/// コードの読み取りに成功した場合
...
/// コードリーダー画面の表示設定
SWIFT_CLASS("_TtC15NautilusCoreSDK25NautilusCodeReaderSetting")
