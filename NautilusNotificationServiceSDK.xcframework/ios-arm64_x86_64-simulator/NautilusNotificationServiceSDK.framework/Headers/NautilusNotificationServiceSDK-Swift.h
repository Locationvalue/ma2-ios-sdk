...
#ifndef NAUTILUSNOTIFICATIONSERVICESDK_SWIFT_H
#define NAUTILUSNOTIFICATIONSERVICESDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NautilusNotificationServiceSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// プッシュ通知のメッセージを扱うクラス
SWIFT_CLASS("_TtC30NautilusNotificationServiceSDK27NautilusNotificationHandler")
...
SWIFT_CLASS("_TtC30NautilusNotificationServiceSDK28NautilusPushNotificationInfo")
