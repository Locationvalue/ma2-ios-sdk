...
SWIFT_ENUM_FWD_DECL(NSInteger, NautilusUserGenderType)
@class NSDateComponents;
SWIFT_ENUM_FWD_DECL(NSInteger, NautilusPrefectureCode)
@class NSString;
SWIFT_ENUM_FWD_DECL(NSInteger, NautilusUserOptionalAttributeKey)
/// 会員属性の更新を行うためのクラス
