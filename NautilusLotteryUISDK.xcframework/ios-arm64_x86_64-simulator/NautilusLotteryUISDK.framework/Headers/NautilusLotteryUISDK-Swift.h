...
#ifndef NAUTILUSLOTTERYUISDK_SWIFT_H
#define NAUTILUSLOTTERYUISDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NautilusLotteryUISDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// 抽選詳細画面からの処理の委譲先
SWIFT_PROTOCOL("_TtP20NautilusLotteryUISDK43NautilusLotteryDetailViewControllerDelegate_")
@protocol NautilusLotteryDetailViewControllerDelegate
/// 抽選UIから、景品確認ボタンをタップされた時に呼ばれる
/// \param viewController <code>NautilusLotteryDetailViewController</code>のインスタンス
///
/// \param lottery 景品確認の対象となる抽選のデータ
///
/// \param prize 景品確認の対象となる景品のデータ
///
- (void)lotteryDetail:(NautilusLotteryDetailViewController * _Nonnull)viewController didOpen:(NautilusLotteryInfo * _Nonnull)lottery prize:(NautilusLotteryPrizeInfo * _Nonnull)prize;
@end


/// 抽選一覧画面
SWIFT_CLASS("_TtC20NautilusLotteryUISDK33NautilusLotteryListViewController")
@interface NautilusLotteryListViewController : UIViewController
@property (nonatomic, readonly) UIInterfaceOrientationMask supportedInterfaceOrientations;
- (void)viewDidLoad;
...
@interface NautilusLotteryUI : NSObject <NautilusFeature>
/// 設定値ファイル
...
/// 抽選一覧画面を表示する
/// \param viewController 抽選一覧画面を表示するView Controller
///
- (void)presentLotteryListViewControllerIn:(UIViewController * _Nonnull)viewController;
/// 抽選一覧画面を生成する
///
/// returns:
