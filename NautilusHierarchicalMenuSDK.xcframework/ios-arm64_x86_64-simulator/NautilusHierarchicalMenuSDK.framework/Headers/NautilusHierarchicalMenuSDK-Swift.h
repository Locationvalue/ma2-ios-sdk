...
#ifndef NAUTILUSHIERARCHICALMENUSDK_SWIFT_H
#define NAUTILUSHIERARCHICALMENUSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NautilusHierarchicalMenuSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSError;
/// アプリとのインターフェース
SWIFT_CLASS("_TtC27NautilusHierarchicalMenuSDK24NautilusHierarchicalMenu")
@interface NautilusHierarchicalMenu : NSObject <NautilusFeature>
...
/// <code>NautilusHierarchicalMenuSDK</code>の機能の利用可否ステータス
