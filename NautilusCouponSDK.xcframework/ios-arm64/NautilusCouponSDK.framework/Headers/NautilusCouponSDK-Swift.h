...
SWIFT_ENUM_FWD_DECL(NSInteger, NautilusCouponPublishType)
...
/// 親のカテゴリーID
@property (nonatomic, readonly) NSInteger parentCategoryID;
/// カテゴリーの名前
...
@property (nonatomic, readonly) NSInteger couponID;
/// クーポンの管理タイトル
@property (nonatomic, readonly, copy) NSString * _Nonnull couponManageTitle;
/// クーポンのタイトル
@property (nonatomic, readonly, copy) NSString * _Nullable couponTitle;
/// クーポンの本文
@property (nonatomic, readonly, copy) NSString * _Nonnull couponText;
/// クーポンの注意事項のテキスト
@property (nonatomic, readonly, copy) NSString * _Nullable noticeText;
/// クーポンの掲載開始日時
@property (nonatomic, readonly, copy) NSDate * _Nonnull publishStartDate;
/// クーポンの掲載終了日時
@property (nonatomic, readonly, copy) NSDate * _Nullable publishEndDate;
/// クーポンの利用開始日時
@property (nonatomic, readonly, copy) NSDate * _Nullable useStartDate;
/// クーポンの利用終了日時
@property (nonatomic, readonly, copy) NSDate * _Nullable useEndDate;
/// クーポンに設定されているバーコードの番号 (JAN-13)
@property (nonatomic, readonly, copy) NSString * _Nullable barcode;
/// クーポンに設定されているバーコードの画像があるURL
@property (nonatomic, readonly, copy) NSURL * _Nullable barcodeImageURL;
/// クーポンに設定されている特典コード
@property (nonatomic, readonly, copy) NSString * _Nullable couponCode;
/// クーポンの発行上限枚数（NSNumber版）
@property (nonatomic, readonly, strong) NSNumber * _Nullable maxSheetNumber;
/// クーポンの利用方法（消し込みあり or 消し込みなし）（NSNumber版）
@property (nonatomic, readonly, strong) NSNumber * _Nullable useTypeNumber;
/// クーポンの利用可能な時刻（NSNumber版）
@property (nonatomic, readonly, strong) NSNumber * _Nullable useLimitHourNumber;
/// クーポンが属するカテゴリの識別子の一覧
...
/// クーポンに設定されている画像の一覧
@property (nonatomic, readonly, copy) NSArray<NautilusCouponImageInfo *> * _Nullable couponImages;
/// クーポンの消し込みを行なった日時
@property (nonatomic, readonly, copy) NSDate * _Nullable useDate;
/// クーポン種別（NSNumber版）
@property (nonatomic, readonly, strong) NSNumber * _Nullable couponTypeNumber;
/// クーポンがお気に入りに登録されているかどうか（NSNumber版）
@property (nonatomic, readonly, strong) NSNumber * _Nullable isFavoritedNumber;
/// クーポンの利用数（NSNumber版）
@property (nonatomic, readonly, strong) NSNumber * _Nullable useCountNumber;
/// 景品クーポンの発行ID（NSNumber版）
@property (nonatomic, readonly, strong) NSNumber * _Nullable exchangeIDNumber;
/// エイリアス
/// ポイント管理として登録した景品クーポンの場合のみ
@property (nonatomic, readonly, copy) NSString * _Nullable alias;
/// 消費ポイント（NSNumber版）
@property (nonatomic, readonly, strong) NSNumber * _Nullable requirePointNumber;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_ENUM_FWD_DECL(NSInteger, NautilusCouponLogType)
/// クーポン閲覧APIに引き渡すパラメーター
SWIFT_CLASS("_TtC17NautilusCouponSDK17NautilusCouponLog")
@interface NautilusCouponLog : NSObject
/// クーポン閲覧APIに引き渡すパラメーター
/// \param coupon 記録をするクーポン
///
/// \param logType ログ種別
///
- (nonnull instancetype)initWithCoupon:(NautilusCouponInfo * _Nonnull)coupon logType:(enum NautilusCouponLogType)logType OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_ENUM_FWD_DECL(NSInteger, NautilusCouponPublishTriggerType)
...
/// 利用するクーポン
@property (nonatomic, readonly, strong) NautilusCouponInfo * _Nonnull coupon;
/// クーポン利用を実行するための情報を生成する
/// 景品クーポン以外であれば、クーポン情報のみで初期化を行う
/// \param coupon 利用するクーポンの情報
///
- (nonnull instancetype)initWithCoupon:(NautilusCouponInfo * _Nonnull)coupon;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
