...
SWIFT_ENUM_FWD_DECL(NSInteger, ShopDetailItem)
SWIFT_ENUM_FWD_DECL(NSInteger, NautilusShopDetailModifierTarget)
...
/// 店舗アピール情報
  ShopDetailItemAppeal = 2,
/// キャッチフレーズ
  ShopDetailItemCatchphrase = 3,
/// 住所
  ShopDetailItemAddress = 4,
/// 店舗電話番号。サイズのみ変更可能。
  ShopDetailItemTelephone = 5,
/// 拡張電話番号。サイズのみ変更可能。
  ShopDetailItemSubTelephone = 6,
/// 店舗アクセス
  ShopDetailItemAccess = 7,
/// 店舗距離
  ShopDetailItemDistance = 8,
};
